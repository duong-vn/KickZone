...
async function main() {
  ...
  // 2. Sample Fields List
  const FIELDS_DATA = [
    {
      name: 'Sân bóng Futsal Chảo Lửa',
      slug: 'san-futsal-chao-lua-tan-binh',
      description: 'Cụm sân cỏ nhân tạo và sàn futsal cao cấp, có khán đài và đèn chiếu sáng hiện đại.',
    ...
    },
    {
      ...
      description: 'Sân bóng trung tâm Quận 1, mặt cỏ êm ái, bãi giữ xe rộng rãi, phục vụ nước uống và áo tập.',
    ...
    },
    {
      ...
      description: 'Khu liên hợp thể thao Thảo Điền với không gian thoáng mát, mặt sân 7 người đạt chuẩn FIFA.',
    ...
    },
    {
      ...
      description: 'Sân bóng 11 người mặt cỏ tự nhiên kết hợp nhân tạo chuẩn quốc tế, có đường chạy pitch.',
    ...
    },
    {
      ...
      description: 'Sân bóng cỏ nhân tạo mới thay mặt cỏ 2026, thoát nước cực tốt khi trời mưa.',
    ...
    },
    {
      ...
      description: 'Nằm cạnh công viên Gia Định nhiều cây xanh trong lành, hệ thống chiếu sáng LED chống chói.',
    ...
    },
    {
      ...
      description: 'Sân bóng 5 người cỏ mềm, phù hợp cho các trận giao lưu công ty và sinh viên.',
    ...
    },
    {
      ...
      description: 'Cụm sân 7 người nằm trong khuôn viên khách sạn Kỳ Hòa, an ninh tốt, tiện ích đầy đủ.',
    ...
    },
    {
      ...
      description: 'Sân bóng 5 người tại trung tâm Phú Nhuận, vị trí đắc địa, dễ di chuyển từ các quận.',
    ...
    },
    {
      ...
      description: 'Sân bóng 7 người cao cấp tại Nam Sài Gòn, phòng thay đồ máy lạnh và vòi tắm hoa sen.',
    ...
    },
    {
      ...
      description: 'Sân 11 người rộng rãi, bề mặt cỏ đạt chuẩn, phù hợp tổ chức các giải đấu phong trào.',
    ...
    },
    {
      ...
      description: 'Khu sân bóng đẳng cấp trong đô thị Celadon, mặt cỏ nhập khẩu, có khu canteen hiện đại.',
